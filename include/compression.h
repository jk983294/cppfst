...
// of LZ4 and ZSTD
// #define LZ4_COMPRESSBOUND(isize)  ((unsigned)(isize) > (unsigned)LZ4_MAX_INPUT_SIZE ? 0 : (isize) + ((isize)/255) +
// 16)
...
typedef unsigned int (*CompAlgorithm)(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                                      int compressionLevel);

// Function pointer to decompression algorithm
typedef unsigned int (*DecompAlgorithm)(char* dst, unsigned int dstCapacity, const char* src,
                                        unsigned int compressedSize);

// UNCOMPRESS,

unsigned int NoCompression(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                           int compressionLevel);
...
unsigned int LZ4_INT_TO_BYTE_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                               int compressionLevel);

unsigned int LZ4_INT_TO_BYTE_D(char* dst, unsigned int dstCapacity, const char* src, unsigned int compressedSize);

unsigned int ZSTD_INT_TO_BYTE_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                                int compressionLevel);

unsigned int ZSTD_INT_TO_BYTE_D(char* dst, unsigned int dstCapacity, const char* src, unsigned int compressedSize);

unsigned int LZ4_INT_TO_SHORT_SHUF2_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                                      int compressionLevel);

unsigned int LZ4_INT_TO_SHORT_SHUF2_D(char* dst, unsigned int dstCapacity, const char* src,
                                      unsigned int compressedSize);

unsigned int ZSTD_INT_TO_SHORT_SHUF2_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                                       int compressionLevel);

unsigned int ZSTD_INT_TO_SHORT_SHUF2_D(char* dst, unsigned int dstCapacity, const char* src,
                                       unsigned int compressedSize);

// Factor algorithms

unsigned int INT_TO_BYTE_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                           int compressionLevel);

unsigned int INT_TO_BYTE_D(char* dst, unsigned int dstCapacity, const char* src, unsigned int compressedSize);

unsigned int INT_TO_SHORT_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                            int compressionLevel);
...
unsigned int LOGIC64_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                       int compressionLevel);
...
unsigned int LZ4_LOGIC64_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                           int compressionLevel);
...
// Buffer src should contain an integer vector (with logicals)
// srcSize must be a multiple of 4
unsigned int ZSTD_LOGIC64_C(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                            int compressionLevel);
...
// srcSize must be a multiple of 4
unsigned int LZ4_C_SHUF4(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                         int compressionLevel);
...
unsigned int LZ4_C_SHUF8(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                         int compressionLevel);
...
unsigned int ZSTD_C_SHUF8(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                          int compressionLevel);
...
unsigned int ZSTD_C_SHUF4(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                          int compressionLevel);
