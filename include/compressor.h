...
public:
    ...
    static int Decompress(unsigned int algo, char* dst, unsigned int dstCapacity, const char* src,
...
public:
    ...
    virtual int Compress(char* dst, unsigned int dstCapacity, const char* src, unsigned int srcSize,
                         CompAlgo& compAlgorithm) = 0;
